...
import 'package:rappieats_customer/ui/phoneAuth/PhoneNumberInputScreen.dart';
...
class _SignUpState extends State<SignUpScreen> {
          ...
          child: Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                contentPadding: EdgeInsets.symmetric(vertical: 8, horizontal: 16),
                fillColor: Colors.white,
                hintText: 'Codigo de referencia'.tr(),
                focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(25.0), borderSide: BorderSide(color: Color(COLOR_PRIMARY), width: 2.0)),
                errorBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: Theme.of(context).colorScheme.error),
                  borderRadius: BorderRadius.circular(25.0),
          ...
          child: Padding(
            ...
            child: Container(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                  ...
                  Text("Crear cuenta con telefono".tr(),
  ...
  _signUpWithEmailAndPassword() async {
    await showProgress(context, "Creando nueva cuenta...".tr(), false);
