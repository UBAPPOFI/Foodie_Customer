...
import 'package:rappieats_customer/ui/deliveryAddressScreen/DeliveryAddressScreen.dart';
import 'package:rappieats_customer/ui/home/view_all_offer_screen.dart';
import 'package:rappieats_customer/ui/home/view_all_restaurant.dart';
import 'package:rappieats_customer/ui/productDetailsScreen/ProductDetailsScreen.dart';
...
import 'package:rappieats_customer/widget/gradiant_text.dart';
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text("Nuestras categorias", style: TextStyle(color: isDarkMode(context) ? Colors.white : const Color(0xFF000000), fontFamily: "Poppinsm", fontSize: 18)),
                                        GestureDetector(
                                          onTap: () {
                                            push(
                                              context,
                                          ...
                                          child: Text('Ver todos'.tr(), style: TextStyle(color: Color(COLOR_PRIMARY), fontFamily: "Poppinsm")),
                                        ),
                                      ],
                                    ),
                                    GradientText(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text("Mejores restaurantes", style: TextStyle(color: isDarkMode(context) ? Colors.white : const Color(0xFF000000), fontFamily: "Poppinsm", fontSize: 18)),
                                      GestureDetector(
                                        onTap: () {
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Historias", style: TextStyle(color: isDarkMode(context) ? Colors.white : Colors.white, fontFamily: "Poppinsm", fontSize: 18)),
                    GradientText(
                      'Mejores comidas',
                      style: const TextStyle(
                        fontSize: 24,
